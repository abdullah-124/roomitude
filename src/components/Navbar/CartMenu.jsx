...
function CartMenu({ setCartMenu }) {
  ...
  return (
    <main onClick={()=>setCartMenu(false)} className='fixed w-full right-0 h-full pt-14 z-100'>
      <div onClick={(e)=>e.stopPropagation()} className=' w-[300px]  bg-white float-right'>
        {
